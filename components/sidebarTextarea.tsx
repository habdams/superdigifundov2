...
export default function SidebarTextarea(props) {
        ...
        <div className="flex items-start space-x-4 mt-10">
            <div className="min-w-0 flex-1">
                <div className="relative">
                    <div className="border border-gray-300 rounded-lg shadow-sm overflow-hidden focus-within:border-pink-500 focus-within:ring-1 focus-within:ring-pink-500">
                        <label htmlFor="comment" className="sr-only">
                            Klicken Sie hier um eine Notizt zu schreiben
                        </label>
                        <textarea
                            rows={6}
                            name="comment"
                    ...
                    <div className="absolute bottom-0 inset-x-0 pl-3 pr-2 py-2 flex justify-between">
                        ...
                        <div className="flex-shrink-0">
                            <button
                                type="submit"
                                className="flex text-center justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 w-28 font-semibold"
